...
public:
	...
	virtual void OnTriggerVolumeLeaving(const std::shared_ptr<Gameplay::Physics::RigidBody>& trigger);
...
protected:
	float _GemJumpTimer, _AirSpeed, speed = 3.0f, _CoyoteTimeTimer, _DustPoof = 0.25f;
